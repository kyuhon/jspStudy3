...
<body>
    ...
    <div class="search-container">
        <div class="dropdownb">
          <button class="dropdown-button">All images ▼</button>
        </div>
        <input type="text" placeholder="Search for stock images, vectors and videos" class="search-input">
        ...
        <div class="e">
            <div class="ab">
                ...
                <p>We're here to customise licenses that perfectly suit your projects, and provide you with high-res
                    downloads to bring your vision to life.
                </p>
                </div>
                <div class="buttons">
        ...
        <div class="f">
            <div class="ab">
                ...
                <p>Discover and own iconic images from skilled photographers at Alamy Prints Store, with expert craftsmanship,
                    a 30-day guarantee, and hassle-free doorstep delivery.
                </p>
                </div>
                <div class="buttons">
